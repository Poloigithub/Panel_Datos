...
huelgas, el precio de la luz, vivienda, paro registrado y contratación (SEPE),
y el mapa municipal de la provincia.
...
| `scripts/descargar_despidos.py` | Despidos y expedientes de regulación de empleo |
