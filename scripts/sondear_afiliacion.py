...
- **Elecciones sindicales**: cuántos delegados se eligen y de qué sindicato.
...
# El Boletín de Estadísticas Laborales es el paraguas de todo esto; las otras
# son las entradas directas por si el boletín no enlaza lo que interesa.
SEMILLAS = [
    ("boletín", f"{BASE}/estadisticas/bel/welcome.htm"),
    ("afiliación", f"{BASE}/es/estadisticas/tendencias_empleo/index.htm"),
    ("afiliación", f"{BASE}/estadisticas/anuario/welcome.htm"),
    ("elecciones sindicales", f"{BASE}/estadisticas/ES/welcome.htm"),
